...
def prepare_config_for_training(
    ...
    # add new model args    
    config.temporal_aggregation_type = model_args.temporal_aggregation_type
    config.temporal_aggregation_bias = model_args.temporal_aggregation_bias
    config.spatial_grid_pooing_size = model_args.spatial_grid_pooing_size
