...
def build_vision_tower(model_name_or_path: str, config: PretrainedConfig) -> PreTrainedModel:
    ...
    if model_name_or_path is None:
        return None
    # print('build_vision_tower',config.resume_path,model_name_or_path)
    ...
    vision_tower_name = vision_tower_arch if vision_tower_arch is not None else model_name_or_path # siglipvisionmodel
    
    use_s2 = getattr(config, "s2", False)
    # print('build_vision_tower', config.resume_path, vision_tower_name, use_s2, flush=True)
